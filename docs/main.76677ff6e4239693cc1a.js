...
/* harmony export */ });
/* harmony import */ var _emotion_memoize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(717);
...
var is_prop_valid_browser_esm = __webpack_require__(804);
...
var memoize_browser_esm = __webpack_require__(717);
...
var testOmitPropsOnStringTag = is_prop_valid_browser_esm/* default */.Z;
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _emotion_memoize__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(717);
/* harmony import */ var _emotion_is_prop_valid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(804);
/* harmony import */ var styled_system__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(980);
...
var createShouldForwardProp = function createShouldForwardProp(props) {
  ...
  return (0,_emotion_memoize__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(function (prop) {
    return (0,_emotion_is_prop_valid__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(prop) && !regex.test(prop);
  });
};
...
exports.kC = exports.xu = void 0;

var _react = _interopRequireDefault(__webpack_require__(294));

var _styled = _interopRequireDefault(__webpack_require__(608));

var _styledSystem = __webpack_require__(980);

var _css = _interopRequireWildcard(__webpack_require__(947));

var _shouldForwardProp = _interopRequireDefault(__webpack_require__(8));
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "borders": () => (/* reexport */ border_dist_index_esm),
  "bottom": () => (/* binding */ bottom),
  "boxShadow": () => (/* reexport */ shadow_dist_index_esm),
  "buttonStyle": () => (/* reexport */ buttonStyle),
  "color": () => (/* reexport */ color),
  "colorStyle": () => (/* reexport */ colorStyle),
  "compose": () => (/* reexport */ compose),
  "createParser": () => (/* reexport */ createParser),
  "createStyleFunction": () => (/* reexport */ createStyleFunction),
  ...
  "textShadow": () => (/* reexport */ shadow_dist_index_esm),
  "textStyle": () => (/* reexport */ textStyle),
  "top": () => (/* binding */ index_esm_top),
...
var css_dist_index_esm = __webpack_require__(947);
...
var variant = function variant(_ref) {
  ...
  if (Object.keys(variants).length) {
    sx = function sx(value, scale, props) {
      return (0,css_dist_index_esm["default"])(get(scale, value, null))(props.theme);
    };
  } else {
...
;// CONCATENATED MODULE: ./src/store/reducers/customers/types.ts
var CustomersActionEnum;
...
;// CONCATENATED MODULE: ./src/store/reducers/action-creators.ts
...
var allActionCreators = __assign({}, CustomersActionCreators);
...
var useActions = function useActions() {
  ...
  return redux_bindActionCreators(allActionCreators, dispatch);
};
...
var dist = __webpack_require__(411);
...
var Text = (0,react.forwardRef)(function (props, ref) {
  return react.createElement(dist/* Box */.xu, index_esm_extends({
    ref: ref,
    tx: "text"
  }, props));
});
var Heading = (0,react.forwardRef)(function (props, ref) {
  return react.createElement(dist/* Box */.xu, index_esm_extends({
    ref: ref,
    as: "h2",
    tx: "text",
...
var Link = (0,react.forwardRef)(function (props, ref) {
  return react.createElement(dist/* Box */.xu, index_esm_extends({
    ref: ref,
    as: "a",
    variant: "link"
...
var Image = (0,react.forwardRef)(function (props, ref) {
  return react.createElement(dist/* Box */.xu, index_esm_extends({
    ref: ref,
    as: "img"
  }, props, {
...
var Card = (0,react.forwardRef)(function (props, ref) {
  return react.createElement(dist/* Box */.xu, index_esm_extends({
    ref: ref,
    variant: "card"
  }, props));
...
var App = function App() {
  var _a = useActions(),
      setCustomers = _a.setCustomers,
      setAgeFilter = _a.setAgeFilter;

  var _b = useTypedSelector(function (state) {
    return state.customers;
  }),
      customers = _b.customers,
      ageFilter = _b.ageFilter;

  var dummyData = [{
    first_name: "Tom",
    second_name: "Redl",
    profilePhoto: "https://static.wikia.nocookie.net/harrypotter/images/a/aa/Voldemort_Headshot_DHP1.png",
    age: 71,
    email: "thenamethatcantbesaid@voldemort.com"
  }, {
    first_name: "Harry",
    second_name: "Potter",
    profilePhoto: "https://static.wikia.nocookie.net/harrypotter/images/9/97/Harry_Potter.jpg",
    age: 17,
    email: "harry@potter.com"
  }, {
    first_name: "Sirius",
    second_name: "Black",
    profilePhoto: "https://static.wikia.nocookie.net/harrypotter/images/b/bc/OOTP_promo_front_closeup_Sirius_Black.jpg",
    age: 36,
    email: "sirius@black.com"
  }, {
    first_name: "Mrs.",
    second_name: "Norris",
    profilePhoto: "https://static.wikia.nocookie.net/harrypotter/images/f/f7/Mrs_Norris_PS.png",
    age: 14,
    email: "alllovescats@filch.com"
  }, {
    first_name: "Luna",
    second_name: "Lovegood",
    profilePhoto: "https://static.wikia.nocookie.net/harrypotter/images/e/ed/Luna_Lovegood.jpg",
    age: 16,
    email: "luna@Lovegood.com"
  }, {
    first_name: "Barty",
    second_name: "Crouch Junior",
    profilePhoto: "https://static.wikia.nocookie.net/harrypotter/images/f/f4/Barty_Crouch_Junior.jpg",
    age: 36,
    email: "doctor@who.com"
  }];
  var ageRange = react.useCallback(function () {
    return {
      max: Math.max.apply(null, customers.map(function (e) {
        return e.age;
      })),
      min: Math.min.apply(null, customers.map(function (e) {
        return e.age;
      }))
    };
  }, [customers]);
  var rangeInputHanler = react.useCallback(function (e) {
...
;// CONCATENATED MODULE: ./src/store/reducers/customers/index.ts
var customers_assign = undefined && undefined.__assign || function () {
  customers_assign = Object.assign || function (t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
      s = arguments[i];
  ...
  return customers_assign.apply(this, arguments);
};
